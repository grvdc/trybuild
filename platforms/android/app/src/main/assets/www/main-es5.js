...
var routes = [
    ...
    {
        path: 'login-page',
        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-login-page-login-page-module */ "pages-login-page-login-page-module").then(__webpack_require__.bind(null, /*! ./pages/login-page/login-page.module */ "./src/app/pages/login-page/login-page.module.ts")).then(function (m) { return m.LoginPagePageModule; }); }
    },
    {
        path: 'cart-page',
        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-cart-page-cart-page-module */ "pages-cart-page-cart-page-module").then(__webpack_require__.bind(null, /*! ./pages/cart-page/cart-page.module */ "./src/app/pages/cart-page/cart-page.module.ts")).then(function (m) { return m.CartPagePageModule; }); }
    },
    {
        path: 'shop-bycaegorie',
        loadChildren: function () { return Promise.all(/*! import() | pages-shop-bycaegorie-shop-bycaegorie-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-shop-bycaegorie-shop-bycaegorie-module")]).then(__webpack_require__.bind(null, /*! ./pages/shop-bycaegorie/shop-bycaegorie.module */ "./src/app/pages/shop-bycaegorie/shop-bycaegorie.module.ts")).then(function (m) { return m.ShopBycaegoriePageModule; }); }
    },
    {
        path: 'product-detail-page',
        loadChildren: function () { return Promise.all(/*! import() | pages-product-detail-page-product-detail-page-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-product-detail-page-product-detail-page-module")]).then(__webpack_require__.bind(null, /*! ./pages/product-detail-page/product-detail-page.module */ "./src/app/pages/product-detail-page/product-detail-page.module.ts")).then(function (m) { return m.ProductDetailPagePageModule; }); }
    },
    {
        path: 'wishlist',
        loadChildren: function () { return Promise.all(/*! import() | pages-wishlist-wishlist-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-wishlist-wishlist-module")]).then(__webpack_require__.bind(null, /*! ./pages/wishlist/wishlist.module */ "./src/app/pages/wishlist/wishlist.module.ts")).then(function (m) { return m.WishlistPageModule; }); }
    },
    {
        path: 'stepper',
    ...
    {
        path: 'address-screen',
        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-address-screen-address-screen-module */ "pages-address-screen-address-screen-module").then(__webpack_require__.bind(null, /*! ./pages/address-screen/address-screen.module */ "./src/app/pages/address-screen/address-screen.module.ts")).then(function (m) { return m.AddressScreenPageModule; }); }
    },
    {
        path: 'all-address',
        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-all-address-all-address-module */ "pages-all-address-all-address-module").then(__webpack_require__.bind(null, /*! ./pages/all-address/all-address.module */ "./src/app/pages/all-address/all-address.module.ts")).then(function (m) { return m.AllAddressPageModule; }); }
    },
    {
        path: 'invoice-page',
...
module.exports = ".my-menu {\n  --width: 65%;\n}\n.my-menu .my-custom-menu {\n  height: 100%;\n  background: #de6161;\n}\n.my-menu .my-custom-menu .profile {\n  top: 0;\n  right: 0;\n  left: 0;\n  z-index: 0;\n  overflow: hidden;\n  text-align: center;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  width: 100%;\n  padding-top: 15px;\n  background: #401a1a;\n}\n.my-menu .my-custom-menu .profile .profile-picture {\n  border-radius: 50%;\n  width: 135px;\n  height: 135px;\n}\n.my-menu .my-custom-menu .r {\n  -webkit-tap-highlight-color: transparent;\n}\n.my-menu .my-custom-menu ion-list {\n  -webkit-tap-highlight-color: transparent;\n  background: transparent !important;\n  height: 100% !important;\n  overflow: scroll !important;\n  padding: 0px;\n}\n.my-menu .my-custom-menu ion-list ion-item {\n  padding-left: 5%;\n}\n.my-menu .my-custom-menu ion-list ion-item ion-icon {\n  color: #fff;\n}\n.my-menu .my-custom-menu ion-list ion-item ion-label {\n  color: #fff;\n}\n.active {\n  background: #e23f3f;\n}\n.ion-activatable {\n  position: relative;\n  overflow: hidden;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _tsFiles_dummyUser__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./tsFiles/dummyUser */ "./src/app/tsFiles/dummyUser.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, menu, router) {
        ...
        this.menu = menu;
        this.router = router;
        this.dummyUser = _tsFiles_dummyUser__WEBPACK_IMPORTED_MODULE_6__["dummyUser"].user;
        this.profilepic = '';
        this.menuItem = [
        ...
        if (!this.login) {
            ...
            this.dummyUser.map(function (item) {
                if (_this.login === item.email) {
                    _this.profilepic = item.img;
                }
            });
        }
    }
    ...
    AppComponent.prototype.highlightedOff = function () {
        this.menuItem.forEach(function (values) {
    ...
    AppComponent.prototype.openDetailsWithQueryParams = function (data) {
...
/* harmony import */ var _components_error_popup_error_popup_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/error-popup/error-popup.component */ "./src/app/components/error-popup/error-popup.component.ts");
...
var CheckoutFormStepperComponent = /** @class */ (function () {
    function CheckoutFormStepperComponent() {
    }
    CheckoutFormStepperComponent.prototype.ngOnInit = function () { };
    ...
    return CheckoutFormStepperComponent;
}());
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvZXJyb3ItcG9wdXAvZXJyb3ItcG9wdXAuY29tcG9uZW50LnNjc3MifQ== */"
...
var ErrorPopupComponent = /** @class */ (function () {
    function ErrorPopupComponent(modal) {
        this.modal = modal;
        console.log("errorList", this.errorList);
    }
    ErrorPopupComponent.prototype.ngOnInit = function () { };
    ErrorPopupComponent.prototype.closeModal = function () {
        this.modal.dismiss({
            'dismissed': true
        });
    };
    ...
    ], ErrorPopupComponent.prototype, "errorList", void 0);
...
/***/ "./src/app/tsFiles/dummyUser.ts":
/*!**************************************!*\
  !*** ./src/app/tsFiles/dummyUser.ts ***!
  \**************************************/
/*! exports provided: dummyUser */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var dummyUser = {
    user: [{
            id: 1,
            img: 'https://nwsid.net/wp-content/uploads/2015/05/dummy-profile-pic.png',
            email: 'gauravk@ocodewire.com',
            password: '123'
        },
        {
            id: 2,
            img: 'data:image/jpeg;base64,',
            email: 'seemag@ocodewire.com',
            password: '123'
        },
        {
            id: 3,
            img: 'https://asisscientific.com.au/wp-content/uploads/2017/06/dummy-profile.jpg',
            email: 'gaurav@abc.com',
            password: '123'
        },
        {
            id: 4,
            img: 'http://wordpress.let.vupr.nl/newsreader/files/2012/12/roxane.png',
            email: 'seema@abc.com',
            password: '123'
        },
        {
            id: 5,
            img: 'https://www.baypointsd.academy/wp-content/uploads/2017/01/dummy-profile.pnghttps://shoptommy.scene7.com/is/image/ShopTommy/WW25155_403_FNT?wid=222&hei=332&fmt=jpeg&qlt=90%2C0&resMode=trilin&op_usm=0.8%2C1.0%2C6%2C0&iccEmbed=0&cropN=0.165%2C0%2C0.67%2C1&op_sharpen=1',
            email: 'grvdc@abc.com',
            password: '123'
        },
        {
            id: 6,
            img: 'https://www.baypointsd.academy/wp-content/uploads/2017/01/dummy-profile.png',
            email: 'abc@abc.com',
            password: '123'
        },
    ]
...
module.exports = __webpack_require__(/*! /home/ubc-21/Documents/ionapp/git/newGit/nlfIonic/src/main.ts */"./src/main.ts");
