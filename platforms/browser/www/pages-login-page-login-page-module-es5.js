...
var LoginPagePageRoutingModule = /** @class */ (function () {
    function LoginPagePageRoutingModule() {
    }
...
var LoginPagePage = /** @class */ (function () {
    function LoginPagePage(toastController, router, modal, alertController) {
    ...
    LoginPagePage.prototype.presentModal = function (error) {
    ...
    LoginPagePage.prototype.checkData = function () {
        this.error = [];
