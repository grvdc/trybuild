...
var AllAddressPageRoutingModule = /** @class */ (function () {
    function AllAddressPageRoutingModule() {
    }
    ...
    return AllAddressPageRoutingModule;
}());
...
var AllAddressPageModule = /** @class */ (function () {
    function AllAddressPageModule() {
    }
...
var AllAddressPage = /** @class */ (function () {
    function AllAddressPage(router) {
        var _this = this;
        this.router = router;
        this.login = '';
        this.address = [];
        ...
        this.address.filter(function (item) {
            if (item.email == _this.login) {
                _this.clientAddress = item.address;
                // console.log("Address", item);
            }
        });
        console.log('cleintaddress', this.clientAddress);
    }
    AllAddressPage.prototype.ngOnInit = function () {
    };
    AllAddressPage.prototype.sendBacktoInvoice = function (data) {
    ...
    AllAddressPage.prototype.addAddress = function () {
        this.router.navigate(['address-screen']);
    };
    AllAddressPage.prototype.remove = function (index) {
        var _this = this;
        this.clientAddress.splice(index, 1);
        this.address.filter(function (item) {
            if (item.email == _this.login) {
                item.address = _this.clientAddress;
                // console.log("Address", item);
            }
        });
        localStorage.setItem('address', JSON.stringify(this.address));
    };
    AllAddressPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-all-address-all-address-module-es5.js.map